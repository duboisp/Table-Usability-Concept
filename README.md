...
Javascript Table Parser source code: Original location in the WET Toolbox](https://github.com/wet-boew/wet-boew/blob/master/src/js/workers/parser.table.js), [Copy this repository](https://github.com/duboisp/Table-Usability-Concept/blob/master/Polyfill/parser.table.js)
